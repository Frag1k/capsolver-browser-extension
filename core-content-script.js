...
(() => {
  ...
  var te = (e, t, n, r) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let i of X(t)) !ee.call(e, i) && i !== n && O(e, i, {
        get: () => t[i],
        enumerable: !(r = J(t, i)) || r.enumerable
      });
    return e
  };
  var R = (e, t, n) => (n = e != null ? G(Y(e)) : {}, te(t || !e || !e.__esModule ? O(n, "default", {
    value: e,
    enumerable: !0
  }) : n, e));
  var z = C((le, _) => {
    ...
    var h = typeof Reflect == "object" ? Reflect : null,
      j = h && typeof h.apply == "function" ? h.apply : function(t, n, r) {
    ...
    u.prototype.setMaxListeners = function(t) {
      if (typeof t != "number" || t < 0 || A(t)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + t + ".");
    ...
    u.prototype.emit = function(t) {
      ...
      if (typeof d == "function") j(d, this, n);
      else
        for (var c = d.length, l = I(d, c), r = 0; r < c; ++r) j(l[r], this, n);
      return !0
    };

    function T(e, t, n, r) {
      var i, o, s;
      if (y(n), o = e._events, o === void 0 ? (o = e._events = Object.create(null), e._eventsCount = 0) : (o.newListener !== void 0 && (e.emit("newListener", t, n.listener ? n.listener : n), o = e._events), s = o[t]), s === void 0) s = o[t] = n, ++e._eventsCount;
      else if (typeof s == "function" ? s = o[t] = r ? [n, s] : [s, n] : r ? s.unshift(n) : s.push(n), i = N(e), i > 0 && s.length > i && !s.warned) {
        s.warned = !0;
        ...
        a.name = "MaxListenersExceededWarning", a.emitter = e, a.type = t, a.count = s.length, ne(a)
      }
      return e
    }
    ...
    u.prototype.once = function(t, n) {
      return y(n), this.on(t, k(this, t, n)), this
    };
    u.prototype.prependOnceListener = function(t, n) {
      return y(n), this.prependListener(t, k(this, t, n)), this
    };
    u.prototype.removeListener = function(t, n) {
      var r, i, o, s, a;
      if (y(n), i = this._events, i === void 0) return this;
      ...
      if (r === n || r.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete i[t], i.removeListener && this.emit("removeListener", t, r.listener || n));
        ...
        o === 0 ? r.shift() : ie(r, o), r.length === 1 && (i[t] = r[0]), i.removeListener !== void 0 && this.emit("removeListener", t, a || n)
      }
      return this
    };
          ...
          let a = [],
            d = c => {
              if (c !== void 0 && c._chunkSplit) {
                let l = c._chunkSplit;
                a = [...a, ...c.data], l.lastChunk && (this.off(i, d), o(a))
              } else this.off(i, d), o(c)
            };
          this.on(i, d);
          try {
            let c = t.map(l => ({
  ...
  var U = (e, t) => {
    window.addEventListener("message", n => {
      if (n.source === window && n.data.from !== void 0 && n.data.from === t) {
        let r = n.data[0],
          i = e.getEvents();
        for (let o in i) o === r.event && i[o](r.payload)
      }
    }, !1)
  };
  var V = R(Q()),
  ...
  var $ = new p({
    ...
    send(e) {
      H || (x.postMessage(e), window.postMessage({
        ...e,
